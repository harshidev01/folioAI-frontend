        ...
        <div className="flex justify-center flex-col items-center">
            ...
            <div className="flex gap-36 mt-30">
                <div className=" flex flex-col justify-center items-center w-[15vw] h-fit text-sm font-semibold text-gray-500 transition-transform duration-300 hover:-translate-y-2">
                    <div className="bg-gray-300 rounded-full w-[2vw] h-[4vh] justify-center items-center flex text-white ">1</div>
                ...
                <div className=" flex flex-col justify-center items-center  w-[15vw] h-fit text-sm font-semibold text-gray-500 transition-transform duration-300 hover:-translate-y-2">
                    <div className="bg-gray-300 rounded-full w-[2vw] h-[4vh] justify-center items-center flex text-white">2</div>
                    <div className="flex mt-10"><img src=" how-it-works-pic2.png"/></div>
                    <div className="mt-7">Folio scans, organizes, builds and translates your catalog to multiple languages—no tech skills needed.</div>
                </div>
                <div className=" flex flex-col justify-center items-center  w-[15vw] h-fit text-sm font-semibold text-gray-500 transition-transform duration-300 hover:-translate-y-2">
                    <div className="bg-gray-300 rounded-full w-[2vw] h-[4vh] justify-center items-center flex text-white">3</div>
